...
public record AdminTripDTO(
    ...
    public static AdminTripDTO from(Trip trip) {
        return new AdminTripDTO(
                ...
                trip.getClient() == null ? null : trip.getClient().getPhotoUrl(),
                trip.getDriver() == null ? null : trip.getDriver().getId(),
                trip.getDriver() == null ? null : trip.getDriver().getName(),
                trip.getDriver() == null ? null : trip.getDriver().getPhotoUrl(),
                ...
                trip.getVehicle() == null ? null : trip.getVehicle().getPhotoUrl(),
                trip.getStatus(),
                trip.getTripType(),
